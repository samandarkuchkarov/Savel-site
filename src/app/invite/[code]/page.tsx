 ...
 * «Вам дарят месяц Savel+» показывается ТОЛЬКО после подтверждения кода
 * сервером (GET /public/referrals/:code/status): несуществующий, отозванный
 * или истёкший код подарка не обещает. Проверка информационная — истину
 * решает POST /referral/redeem при вводе кода в приложении.
 */
